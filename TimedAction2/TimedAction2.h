...
|| | License afloat with this library; if not, write to the Free Software
|| | Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA  02110-1301  USA
|| #
||
*/

#ifndef TIMEDACTION2_H
#define TIMEDACTION2_H
...
class TimedAction2 {
  ...
  public:
    TimedAction2(unsigned float interval,void (*function)());
    TimedAction2(unsigned float prev,unsigned float interval,void (*function)());
	...
	void setInterval( unsigned float interval );

  private: 
    bool active;
    unsigned float previous;
    unsigned float interval;
    void (*execute)();
...
/*
|| @changelog
|| | 1.6 2010-10-08 - Alexander Brevig : Changed datatype of interval from unsigned int to unsigned float
